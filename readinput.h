...
void refresh_var(std::string vname, double value, Chicane &param_chi, auxParam &param_auxp, std::map <std::string, std::string> & var); // reset all parameters when do scanning
